...
const zhCN3: TranslationMap = {
  ...
  'workspace.openingVaultTitle': '正在在 Obsidian 中打开仓库',
  'workspace.openingVaultMessage':
    '如果 Obsidian 未打开，请从 obsidian.md 安装，或使用「显示文件夹」。仓库路径：',
  'workspace.openVaultFailedTitle': '无法在 Obsidian 中打开仓库',
  'workspace.openVaultFailedMessage':
    '请使用「显示文件夹」直接打开仓库目录。仓库路径：',
  'workspace.revealVaultFailed': '无法显示仓库文件夹',
